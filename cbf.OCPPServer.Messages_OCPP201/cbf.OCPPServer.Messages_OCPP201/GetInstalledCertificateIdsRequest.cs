...
namespace cbf.OCPPServer.Messages_OCPP201
{
    ...
    public partial class GetInstalledCertificateIdsRequest
    {
        ...
        /// <br/>
        /// </summary>
        [Newtonsoft.Json.JsonProperty("certificateType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
